...
public class CoinCount {
    static int count = 0;
    public static int coinCount(int[] coins, int target,int index){
        ...
        for (int i =index; i < coins.length; i++)
            sum += coinCount(coins,target-coins[i],i);
        return sum;
    }

    public static int coinCountDP(int[] coins, int target,int index,int[][] dp){
        ...
        int sum = 0;
        for (int i =index; i < coins.length; i++)
            sum += coinCountDP(coins,target-coins[i],i,dp);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(coinCountDP(arr,target,0, new int[target+1][target+1])+ " Result");
        System.out.println(count);
        count = 0;
        //System.out.println(coinCount(arr,target,0)+ " Result");
        System.out.println(count);
    }
